  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (currentUserUid == '') {
        ...
        _model.currentStaffName =
            _model.currentStaff?.elementAtOrNull(0)?.fullName;
        safeSetState(() {});
        _model.todayAttendance = await AttendanceRecordsTable().queryRows(
          queryFn: (q) => q
              .eqOrNull(
                'staff_id',
        ...
        _model.allAttendance = await AttendanceRecordsTable().queryRows(
          queryFn: (q) => q.eqOrNull(
            'staff_id',
            _model.currentStaffId,
          ),
        );
        _model.lateAttendance = await AttendanceRecordsTable().queryRows(
          queryFn: (q) => q
              .eqOrNull(
                'staff_id',
                _model.currentStaffId,
        ...
        _model.leaveBalance = await LeaveBalancesTable().queryRows(
          queryFn: (q) => q.eqOrNull(
            'staff_id',
            _model.currentStaffId,
          ),
        ...
        _model.clockInTime =
            _model.todayAttendance?.elementAtOrNull(0)?.clockIn;
        _model.totalWorkDays = valueOrDefault<int>(
          _model.allAttendance?.length,
          0,
        );
        _model.lateDays = valueOrDefault<int>(
          _model.lateAttendance?.length,
          0,
        );
        _model.remainingLeave = valueOrDefault<int>(
          _model.leaveBalance?.elementAtOrNull(0)?.remainingDays,
          0,
        );
        _model.isClockedIn = _model.todayAttendance != null &&
            (_model.todayAttendance)!.isNotEmpty;
        safeSetState(() {});
      }
      ...
      _model.instantTimer = InstantTimer.periodic(
        ...
        callback: (timer) async {
          _model.currentRealTime = getCurrentTimestamp;
          safeSetState(() {});
        },
                              ...
                              await showDialog(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    title: Text('Taarifa'),
                                    content:
                                        Text('Hakuna taarifa mpya kwa sasa.'),
                                    actions: [
                                      TextButton(
                                        onPressed: () =>
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      _model.isClockedIn == true
                                          ? 'Umeingia saa ${functions.toUTCDisplay(_model.clockInTime)}'
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    if (_model.isClockedIn == false) {
                                      ...
                                      await AttendanceRecordsTable().insert({
                                        'staff_id': _model.currentStaffId,
                                        'clock_in': supaSerialize<DateTime>(
                                            getCurrentTimestamp),
                                        'is_late': functions.isLate(),
                                        'work_date': supaSerialize<DateTime>(
                                            getCurrentTimestamp),
                                      });
                                      _model.isClockedIn = true;
                                      _model.clockInTime = getCurrentTimestamp;
                                      safeSetState(() {});
                                      ScaffoldMessenger.of(context)
                                          .showSnackBar(
                                        SnackBar(
                                          content: Text(
                                            'Sasa umeingia kazini',
                                            style: TextStyle(
                                              color:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryBackground,
                                      ...
                                      await AttendanceRecordsTable().update(
                                        data: {
                                          'clock_out': supaSerialize<DateTime>(
                                              getCurrentTimestamp),
                                        },
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        valueOrDefault<String>(
                                          _model.remainingLeave?.toString(),
                                          '0',
                                        ),
                                        style: FlutterFlowTheme.of(context)
                                            .displaySmall
                                            ...
                                            valueOrDefault<String>(
                                              functions
                                                  .calculatePunctualityRate(
                                                      valueOrDefault<int>(
                                                        _model.allAttendance
                                                            ?.length,
                                                        0,
                                                      ),
                                                      valueOrDefault<int>(
                                                        _model.lateAttendance
                                                            ?.length,
                                                        0,
                                                      )),
                                              '0',
                    ...
                    child: Row(
                      ...
                      children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              Icon(
                                Icons.home_rounded,
                                color:
                                    getCurrentRoute(context) == '/homepagestaff'
                        ...
                        InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed(
                                HistoriayaMahudhurioWidget.routeName);
                          },
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            mainAxisAlignment: MainAxisAlignment.center,
                        ...
                        Column(
                          ...
                          children: [
                            Icon(
                              Icons.event_available_rounded,
                              color: getCurrentRoute(context) == '/leavepage'
                                  ? FlutterFlowTheme.of(context).primary
                                  : FlutterFlowTheme.of(context).accent4,
                              size: 24.0,
                            ),
