...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1F3E8A);
  late Color secondary = const Color(0xFF19A55A);
  late Color tertiary = const Color(0xFF0B7FAE);
  late Color alternate = const Color(0xFF0056A0);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF333333);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF5F5F5);
  late Color accent1 = const Color(0xFF0B7FAE);
  late Color accent2 = const Color(0xFF007BFF);
  late Color accent3 = const Color(0xFF28A745);
  late Color accent4 = const Color(0xFF6C757D);
  ...
  late Color customColor1 = const Color(0xFF4521C6);
  late Color customColor2 = const Color(0xFFF4D9DC);
  late Color customColor3 = const Color(0xFF047E2B);
  late Color customColor4 = const Color(0xFFBAF9BA);
  ...
  late Color blue = const Color(0xFF1F3E8A);
  late Color green = const Color(0xFF19A55A);
  late Color teal = const Color(0xFF0B7FAE);
