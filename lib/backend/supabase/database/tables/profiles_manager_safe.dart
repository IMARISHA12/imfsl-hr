...
class ProfilesManagerSafeTable extends SupabaseTable<ProfilesManagerSafeRow> {
  @override
  String get tableName => 'profiles_manager_safe';

  @override
  ProfilesManagerSafeRow createRow(Map<String, dynamic> data) =>
      ProfilesManagerSafeRow(data);
}

class ProfilesManagerSafeRow extends SupabaseDataRow {
  ProfilesManagerSafeRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ProfilesManagerSafeTable();
