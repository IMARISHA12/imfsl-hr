...
class HealthCheckReportsTable extends SupabaseTable<HealthCheckReportsRow> {
  @override
  String get tableName => 'health_check_reports';

  @override
  HealthCheckReportsRow createRow(Map<String, dynamic> data) =>
      HealthCheckReportsRow(data);
}

class HealthCheckReportsRow extends SupabaseDataRow {
  HealthCheckReportsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => HealthCheckReportsTable();
