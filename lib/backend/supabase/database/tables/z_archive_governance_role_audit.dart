...
class ZArchiveGovernanceRoleAuditTable
    extends SupabaseTable<ZArchiveGovernanceRoleAuditRow> {
  @override
  String get tableName => 'z_archive_governance_role_audit';

  @override
  ZArchiveGovernanceRoleAuditRow createRow(Map<String, dynamic> data) =>
      ZArchiveGovernanceRoleAuditRow(data);
}

class ZArchiveGovernanceRoleAuditRow extends SupabaseDataRow {
  ZArchiveGovernanceRoleAuditRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ZArchiveGovernanceRoleAuditTable();
