...
class VMvRefreshStatusDetailedTable
    extends SupabaseTable<VMvRefreshStatusDetailedRow> {
  @override
  String get tableName => 'v_mv_refresh_status_detailed';

  @override
  VMvRefreshStatusDetailedRow createRow(Map<String, dynamic> data) =>
      VMvRefreshStatusDetailedRow(data);
}

class VMvRefreshStatusDetailedRow extends SupabaseDataRow {
  VMvRefreshStatusDetailedRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VMvRefreshStatusDetailedTable();
