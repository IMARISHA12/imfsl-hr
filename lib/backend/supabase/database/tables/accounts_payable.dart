...
class AccountsPayableRow extends SupabaseDataRow {
  AccountsPayableRow(Map<String, dynamic> data) : super(data);
  ...
  DateTime? get glPostedAt => getField<DateTime>('gl_posted_at');
  set glPostedAt(DateTime? value) => setField<DateTime>('gl_posted_at', value);
}
