...
class LoandiskSyncItemsTable extends SupabaseTable<LoandiskSyncItemsRow> {
  @override
  String get tableName => 'loandisk_sync_items';

  @override
  LoandiskSyncItemsRow createRow(Map<String, dynamic> data) =>
      LoandiskSyncItemsRow(data);
}

class LoandiskSyncItemsRow extends SupabaseDataRow {
  LoandiskSyncItemsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => LoandiskSyncItemsTable();
