...
class ProfilesItAdminSafeTable extends SupabaseTable<ProfilesItAdminSafeRow> {
  @override
  String get tableName => 'profiles_it_admin_safe';

  @override
  ProfilesItAdminSafeRow createRow(Map<String, dynamic> data) =>
      ProfilesItAdminSafeRow(data);
}

class ProfilesItAdminSafeRow extends SupabaseDataRow {
  ProfilesItAdminSafeRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ProfilesItAdminSafeTable();
