...
class LoandiskSyncRunsTable extends SupabaseTable<LoandiskSyncRunsRow> {
  @override
  String get tableName => 'loandisk_sync_runs';

  @override
  LoandiskSyncRunsRow createRow(Map<String, dynamic> data) =>
      LoandiskSyncRunsRow(data);
}

class LoandiskSyncRunsRow extends SupabaseDataRow {
  LoandiskSyncRunsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => LoandiskSyncRunsTable();
